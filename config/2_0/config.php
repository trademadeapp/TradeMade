...
if(isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] == 'localhost')
{
    ...
    define('DB_PASS', 'toor.321');
    define('DB_DATABASE', 'trade_made');
    define('DB_PORT', '3306');
    define('DOMAINURL','http://localhost/trademade-backend/');
    define('PROJ_FOLDERNAME','trademade-backend');
    define('LOG_REQUEST_ON',"true");    // true or false
} elseif (isset($_SERVER['HTTP_HOST']) && $_SERVER['HTTP_HOST'] == 'simform.solutions') {
    define('DOMAINURL','http://simform.solutions/');
    define('DB_SERVER', 'localhost');
    define('DB_USER', 'root');
    define('DB_PASS', 'toor.321');
    define('DB_DATABASE', 'trademade');
    define('DB_PORT', '3306');
...
define('IOS_PUSH_PEM_PATH',DOCROOT."pem/certificate_new.pem"); // PROD
